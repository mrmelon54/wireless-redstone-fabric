...
public class WirelessRedstone implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        WIRELESS_FREQUENCY_SCREEN = ScreenHandlerRegistry.registerSimple(new Identifier("wireless-redstone", "frequency_screen"), ((syncId, inventory) -> new WirelessFrequencyGuiDescription(syncId, inventory, ScreenHandlerContext.EMPTY)));

        Registry.register(Registry.BLOCK, new Identifier("wireless-redstone", "transmitter"), WIRELESS_TRANSMITTER);
        Registry.register(Registry.ITEM, new Identifier("wireless-redstone", "transmitter"), new BlockItem(WIRELESS_TRANSMITTER, new FabricItemSettings().group(ItemGroup.REDSTONE).maxCount(64)));
        WIRELESS_TRANSMITTER_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, "wireless-redstone:transmitter", FabricBlockEntityTypeBuilder.create(WirelessTransmitterBlockEntity::new, WIRELESS_TRANSMITTER).build());

        Registry.register(Registry.BLOCK, new Identifier("wireless-redstone", "receiver"), WIRELESS_RECEIVER);
        Registry.register(Registry.ITEM, new Identifier("wireless-redstone", "receiver"), new BlockItem(WIRELESS_RECEIVER, new FabricItemSettings().group(ItemGroup.REDSTONE).maxCount(64)));
        WIRELESS_RECEIVER_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, "wireless-redstone:receiver", FabricBlockEntityTypeBuilder.create(WirelessReceiverBlockEntity::new, WIRELESS_RECEIVER).build());

        Registry.register(Registry.ITEM, new Identifier("wireless-redstone", "handheld"), WIRELESS_HANDHELD);
